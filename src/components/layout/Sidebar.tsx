				...
				<div className='p-4 border-t border-[#588157]/20'>
					{open ? (
						<DropdownMenu>
								...
								>
									<Avatar className='h-8 w-8 border border-[#588157]/30'>
										<AvatarImage
											...
											alt='Profile'
										/>
										<AvatarFallback className='bg-[#588157]/30 text-white'>
											PT
										</AvatarFallback>
									</Avatar>
							...
							<DropdownMenuContent
								align='end'
								className='w-56 border-[#588157]/20'
							>
								<DropdownMenuItem>
									<Link
										href='/profile'
						...
						<DropdownMenu>
							<DropdownMenuTrigger asChild>
								<Button
									variant='ghost'
									size='icon'
									className='rounded-full mx-auto flex justify-center items-center hover:bg-[#588157]/20'
								>
									<Avatar className='h-8 w-8 border border-[#588157]/30'>
										<AvatarImage
											src='/placeholder.svg'

...
export const translations: TranslationsType = {
	en: {
		...
		'flow.subtitle':
			"Here's how the transaction process works from start to finish:",
		...
		'flow.shipped.description':
			"The shipment has been delivered to the buyer's specified address.",
	...
	id: {
		...
		'flow.subtitle':
			'Berikut adalah cara kerja proses transaksi dari awal hingga akhir:',
		...
		'flow.shipped.description':
			'Pengiriman telah sampai di alamat yang ditentukan pembeli.',

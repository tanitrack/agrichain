					...
					<Card className='earth-card-green shadow-md'>
						...
						<CardContent>
							...
							<p className='text-sm text-earth-dark-green mt-1 font-medium'>
								...
								{t('transactions.completed').toLowerCase()}
							</p>
							<div className='h-2 w-full bg-earth-pale-green mt-3 rounded-full'>
								<div
									className='h-2 bg-earth-dark-green rounded-full'
									style={{ width: '70%' }}
								></div>
							</div>
						</CardContent>
					...
					<Card className='earth-card-brown shadow-md'>
						...
						<CardContent>
							...
							<div className='h-2 w-full bg-earth-light-brown mt-3 rounded-full'>
								<div
									className='h-2 bg-earth-brown rounded-full'
									style={{ width: '60%' }}
								></div>
							</div>
						</CardContent>
					...
					<Card className='earth-card-wheat shadow-md'>
						...
						<CardContent>
							...
							<p className='text-sm text-yellow-700 mt-1 font-medium'>
								{
									pendingTransactions.filter((t) => t.status === 'negosiasi')
										.length
								}{' '}
						...
						<CardContent className='pt-4'>
							<div className='space-y-4'>
								{trendingCommodities.map((commodity) => (
									<div
										key={commodity.id}
										className='flex items-center p-3 rounded-lg hover:bg-earth-light-brown/20 transition-colors'
									>
						...
						<CardContent className='pt-4'>
							<div className='space-y-4'>
								{commodities.map((commodity) => (
									<div
										key={commodity.id}
										className='flex items-center p-3 rounded-lg hover:bg-earth-pale-green/30 transition-colors'
									>

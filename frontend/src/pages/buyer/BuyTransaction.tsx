      ...
      <MainLayout>
        <div className="flex h-[60vh] flex-col items-center justify-center">
          ...
          <p className="text-muted-foreground mb-6">
            {language === 'id'
              ? 'Komoditas yang Anda cari tidak tersedia'
              : "The commodity you're looking for is not available"}
          </p>
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
          ...
          <div className="md:col-span-2">
            <Card className="border-earth-light-brown/30 overflow-hidden">
              <CardHeader className="from-earth-medium-green to-earth-pale-green bg-gradient-to-r">
                <CardTitle className="text-white">
                  {language === 'id' ? 'Pesan Komoditas' : 'Order Commodity'}
                </CardTitle>
              ...
              <CardContent className="space-y-6 p-6">
                ...
                <div className="bg-earth-pale-green/30 flex items-center gap-4 rounded-lg p-4">
                  <div className="bg-earth-pale-green/50 flex h-16 w-16 items-center justify-center rounded-lg">
                    <Package className="text-earth-dark-green h-8 w-8" />
                  </div>
                  <div>
                    <h3 className="text-earth-dark-green text-lg font-semibold">
                      {commodity.name}
                    </h3>
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                  <div className="flex items-start gap-3 rounded-lg bg-[#F2FCE2]/50 p-3">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div className="flex items-start gap-3 rounded-lg bg-[#FEF7CD]/50 p-3">
                      <Scale className="text-earth-brown mt-0.5 h-5 w-5" />
                      <div>
                        <p className="text-muted-foreground text-sm">
                        ...
                        <div className="mt-1 flex items-center gap-2">
                          <Button
                            variant="outline"
                            size="sm"
                            className="border-earth-light-brown/30 h-7 w-7 p-0"
                          ...
                          <input
                            ...
                            className="border-earth-light-brown/30 h-8 w-16 rounded-md border text-center"
                          />
                          <Button
                            variant="outline"
                            size="sm"
                    ...
                    <div className="flex items-start gap-3 rounded-lg bg-[#FEF7CD]/50 p-3">
                      <Calendar className="text-earth-brown mt-0.5 h-5 w-5" />
                      <div>
                        <p className="text-muted-foreground text-sm">
                          {language === 'id' ? 'Tanggal Pengiriman' : 'Delivery Date'}
                        </p>
                        <p className="font-medium">
                          {language === 'id' ? 'Akan ditentukan' : 'To be determined'}
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    <label className="text-earth-dark-green text-sm font-medium">
                    ...
                    <Textarea
                      ...
                      className="border-earth-light-brown/30 resize-none"
                      rows={3}
                    />
                  </div>
                </div>
              ...
              <CardFooter className="bg-earth-pale-green/20 flex flex-col justify-between gap-3 p-6 sm:flex-row">
                <div>
                ...
                <Button
                  className="bg-earth-medium-green hover:bg-earth-dark-green min-w-32"
                  size="lg"
          ...
          <div className="space-y-5">
            <Card className="border-earth-light-brown/30">
              ...
              <CardContent className="space-y-4 p-5">
                <div className="rounded-lg bg-[#FDE1D3]/20 p-4">
                  <h4 className="text-earth-brown mb-2 font-medium">
                ...
                <div className="space-y-2">
                  <Badge className="text-earth-dark-green border-earth-medium-green/50 border bg-[#F2FCE2] px-3 py-1">

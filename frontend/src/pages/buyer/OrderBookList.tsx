...
import { ClipboardList, Search, Filter, Eye, Plus, Calendar } from "lucide-react";
          ...
          <div className="flex flex-col gap-4">
            <div className="flex flex-col sm:flex-row gap-4 justify-between">
              <div className="relative flex-1">
                ...
                <Input
                  type="search"
                  placeholder={language === "id" ? "Cari berdasarkan ID atau komoditas" : "Search by ID or commodity"}
                  className="pl-8"
                  value={searchQuery}
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                >
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="accepted">{language === "id" ? "Diterima" : "Accepted"}</SelectItem>
                    <SelectItem value="completed">{language === "id" ? "Selesai" : "Completed"}</SelectItem>
                    <SelectItem value="expired">{language === "id" ? "Kedaluwarsa" : "Expired"}</SelectItem>
            ...
            <Tabs defaultValue="all" className="w-full" onValueChange={setActiveTab}>
              <TabsList className="mb-4">
                ...
                <TabsTrigger value="accepted">{language === "id" ? "Diterima" : "Accepted"}</TabsTrigger>
                <TabsTrigger value="completed">{language === "id" ? "Selesai" : "Completed"}</TabsTrigger>
                <TabsTrigger value="expired">{language === "id" ? "Kedaluwarsa/Batal" : "Expired/Cancelled"}</TabsTrigger>
              </TabsList>
                  ...
                  <Table>
                    <TableHeader>
                      <TableRow>
                        ...
                        <TableHead>{language === "id" ? "Tanggal Pengiriman" : "Delivery Date"}</TableHead>
                        <TableHead>{language === "id" ? "Tanggal Kedaluwarsa" : "Expiry Date"}</TableHead>
                        <TableHead>{language === "id" ? "Status" : "Status"}</TableHead>
                        <TableHead className="text-right">{language === "id" ? "Aksi" : "Action"}</TableHead>
                      </TableRow>
                    </TableHeader>
                    <TableBody>
